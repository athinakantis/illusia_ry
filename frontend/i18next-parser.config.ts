// This file was taken from the next-parser github repo example and modified to work with our project.
export default {
    contextSeparator: '_',
    ...
    defaultValue: (lng: string, ns: string, key: string, fallbackValue: string) => {
      if (lng === 'en') {
